...
def asin_to_detail(self,asin,country):
    asin_detail=Product.objects.filter(asin=asin,country=country)[0]
    try:
        ...
        asin_detail.title=product.title
