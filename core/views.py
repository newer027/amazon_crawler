...
from .forms import ContactForm,Post_Form
...
def rich_text(request):
    #myform = Post_Form(data=request.POST or None)
    #return render(request, 'crawler/rich_text.html', {'myform': myform,})
    return render(request, 'crawler/rich_text.html')
